---
description: Record a test by walking through a website. The agent drives the browser via IPC primitives; the runner captures every command into a markdown test file in ./tests/.
